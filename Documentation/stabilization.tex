...
leads to an additional   non-hermitian second-order error in the measurement of observables $O$
...
\begin{figure}
\center
\includegraphics[width=0.49\textwidth]{Dtau_1.pdf}
\includegraphics[width=0.49\textwidth]{Dtau.pdf}
...
hopping terms.   However,  the  specification of  the  interaction in the   symmetric  form of  Eq.~\ref{eq:f_approx_symm}   has  to be carried out by the user in the Hamiltonian module. 
