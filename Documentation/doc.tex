...
\newcommand{\ALFver}{dev.}          %{2.2}{dev.} version of ALF this document refers to
\newcommand{\ALFbranch}{master}   %{ALF-2.2}{master} corresponding ALF branch
\newcommand{\pyALFver}{dev.}        %{2.2}{dev.} version of pyALF that works with \ALFver
...
%%%  Fakher
\newcommand{\fa}[1]{\textcolor{cyan}{\sf \footnotesize [FA: #1]}}
%%% 
...
% Author list
\begin{center}
The \textbf{ALF Collaboration\textsuperscript}{*}:
...
\textsuperscript{*}\href{mailto:alf@physik.uni-wuerzburg.de}{alf@physik.uni-wuerzburg.de}
\end{center}
