...
In this  section and in  what  follows,  we  will  set  $\tilde{U}_k =0$.  An  explicit  example in which  this  feature  is  used  can  be  found in 
Sec.~\ref{Spin_Peierls.Sec}   where   we  use  to  ALF-library  to  simulate  the    spin-Peierls  Heisenberg  Hamiltonian.  
