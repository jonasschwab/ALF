...
\end{align}
\fa{In light  of  the type 4  moves,  our    Hamiltonian is now  more   general.  This  does  make  things  more  complicated,  such  that we  may  want to 
postpone  this  discussion just to  the   discussion of  the spin-Peierls  Hamiltonian. Or  we  could  include  this in  a   generalization of    $H_V$.   We  should  certainly   discuss  this. }
...
$ \hat{\mathcal{H}}_{0,I}+ \hat{\mathcal{H}}_{I} + + \hat{\mathcal{H}}_{Q}, $ and  has the following properties:
\begin{itemize}
